...
namespace Utilities
{
    ...
    internal class DataSource
    {
        ...
        {
            if (string.IsNullOrEmpty(ConnectHelper.ConnString))
                throw new NoNullAllowedException(nameof(ConnectHelper.ConnString));
            return new SqlConnection(ConnectHelper.ConnString);
        }
    }
}
